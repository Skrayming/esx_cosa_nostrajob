          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_cosa-nostra:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_cosa-nostra:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_cosa-nostra:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                TriggerServerEvent('esx_cosa-nostra:OutVehicle', GetPlayerServerId(player))
              end
...
function OpenBodySearchMenu(player)
  ...
  ESX.TriggerServerCallback('esx_cosa-nostra:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil then
          ...
          TriggerServerEvent('esx_cosa-nostra:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_cosa-nostra:getVehicleInfos', function(infos)
...
RegisterNetEvent('esx_cosa-nostra:handcuff')
AddEventHandler('esx_cosa-nostra:handcuff', function()
...
RegisterNetEvent('esx_cosa-nostra:drag')
AddEventHandler('esx_cosa-nostra:drag', function(cop)
...
RegisterNetEvent('esx_cosa-nostra:putInVehicle')
AddEventHandler('esx_cosa-nostra:putInVehicle', function()
...
RegisterNetEvent('esx_cosa-nostra:OutVehicle')
AddEventHandler('esx_cosa-nostra:OutVehicle', function(t)
...
Citizen.CreateThread(function()
    while true do
		...
		if IsControlPressed(0,  Keys['F9']) and PlayerData.job2 ~= nil and PlayerData.job2.name == 'cosa-nostra' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'bandits_actions') and (GetGameTimer() - GUI.Time) > 150 then
		   OpenBanditsMenu()
        end 
    end
end)
